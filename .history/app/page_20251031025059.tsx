...
const events = [
  {image:'/images/event1.jpg',title:'React Conference 2024'},
  {image:'/images/event2.jpg',title:'JavaScript Summit 2024'},
  {image:'/images/event3.jpg',title:'AI & ML Expo 2024'},
  {image:'/images/event4.jpg',title:'Web Dev Workshop 2024'},
]
const Home = () => {
  return (
    <section>
